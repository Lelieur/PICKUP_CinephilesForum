...
const EditCommunityForm = ({
    community, setShowEditModal, loadCommunityDetails }) => {
    ...
    const [selectedMovies, setSelectedMovies] = useState(community.moviesApiIds)

    const [creditsFilter, setCreditsFilter] = useState([])
    const [selectedDirectors, setSelectedDirectors] = useState(community.fetishDirectors)
    const [selectedActors, setSelectedActors] = useState(community.fetishActors)
    ...
    const [communityData, setCommunityData] = useState({
        ...
        fetishDirectors: community.fetishDirectors.map(director => { return director.id.toString() }),
        fetishActors: community.fetishActors.map(actor => { return actor.id.toString() }),
        decades: community.decades,
        moviesApiIds: community.moviesApiIds.map(movie => { return movie.id.toString() }),
    ...
    const handleMoviesApiIdsChange = movieId => {
        ...
        moviesCopy[moviesCopy.length] = movieId.toString()
        setCommunityData({
    ...
    const handleDirectorsChange = directorId => {
        ...
        directorsCopy[communityData.fetishDirectors.length] = directorId.toString()
        setCommunityData({
    ...
    const handleActorsChange = actorId => {
        ...
        actorsCopy[communityData.fetishActors.length] = actorId.toString()
        setCommunityData({
                    ...
                    <Row>
                        <Col>
                            ...
                            <Form.Group className="mb-3" controlId="titleField">
                                ...
                                <Form.Control type="text" placeholder="Introduce el nombre de la comunidad" value={communityData.title} name={'title'} onChange={handleCommunityDataChange} />
                            </Form.Group>
