...
const UserProfilePage = () => {
  ...
  const fetchReviewsData = () => {
    const reviewsPromises = reviews?.map((review) =>
      ReviewServices.getOneReviewFullData(review)
        .then((response) => {
  ...
  return isLoading ? (
    <Loader message="Cargando Perfil del usuario..." />
  ) : (
    <div className="UserProfilePage">
      <Container className="mt-5">
        <Row className="p-sm-3 d-flex justify-content-center align-items-center">
          <Col xs={3} lg={1}>
            <img
              className="border border-white object-fit-cover rounded-circle"
            ...
            <Row className="align-items-center">
              ...
              <Col xs={{ span: "auto" }}>
                {loggedUser?._id === userId && (
                  <Button
                    className="border-0 fw-bold btn-style-1 bg-transparent"
            ...
            <Row className="order-2 d-flex justify-content-center align-items-center">
              ...
              >
                <Row>
                  <Col
                    as="a"
                    href={socialNetworksProfiles.facebook || "#"}
                    target="_blank"
                    className={
                      socialNetworksProfiles.facebook
                  ...
                  <Col
                    as="a"
                    href={socialNetworksProfiles.twitter || "#"}
                    target="_blank"
                    className={
                      socialNetworksProfiles.twitter
                        ? "text-white text-decoration-none"
                        : "d-none"
                    }
                  >
                  ...
                  <Col
                    as="a"
                    href={socialNetworksProfiles.instagram || "#"}
                    target="_blank"
                    className={
                      socialNetworksProfiles.instagram
                        ? "text-white text-decoration-none"
                        : "d-none"
                    }
                  >
                  ...
                  <Col
                    as="a"
                    href={socialNetworksProfiles.tiktok || "#"}
                    target="_blank"
                    className={
                      socialNetworksProfiles.tiktok
                        ? "text-white text-decoration-none"
                        : "d-none"
                    }
                  >
            ...
            <Row className="mt-3 align-items-center">
              ...
              {loggedUser?._id === userId && (
                <Col
                  xs={{ span: "auto" }}
                  md={{ span: "auto" }}
                  className="me-auto mt-2 mt-md-0"
                >
                  <Button
                    className="border-0 fw-bold btn-style-2 "
